    ...
    public partial class createtable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductCategoryMappingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    CatergoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCategoryMapping", x => x.ProductCategoryMappingId);
                    table.ForeignKey(
                        name: "FK_ProductCategoryMapping_Catergory_CatergoryId",
                        column: x => x.CatergoryId,
                        principalTable: "Catergory",
                        principalColumn: "CatergoryId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategoryMapping_CatergoryId",
